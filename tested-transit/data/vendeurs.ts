  ...
  export const vendeurs: Vendeur[] = [
    {
      ...
      projets: [
        ...
        },
        {
          ...
          image: "../public/cuisines/julien/julien3.png",
          annee: "",
        },
      ],
      avis: [
...
Merci à Eco cuisine d'Andelnans.`,
      ...
      projets: [
        {
          titre: "",
          description: "",
          image: "../public/cuisines/aoued/aoued1.jpg",
          annee: "",
        },
        {
          titre: "",
          description: "",
          image: "../public/cuisines/aoued/aoued2.jpg",
          annee: "",
        },
        {
          titre: "",
          description: "",
          image: "../public/cuisines/aoued/aoued3.jpg",
          annee: "",
        },
      ],
      avis: [
    ...
    },
    {
      ...
      photo: "../public/images/emilie.jpg",
      anciennete: 10,
      depuis: 2016,
      description:
        "Passionné par l'aménagement intérieur depuis plus de 7 ans, Julien accompagne chaque client avec une attention particulière aux détails et une écoute totale. Il transforme vos envies en espaces fonctionnels et esthétiques, en alliant modernité et chaleur humaine. Son approche ? Comprendre votre mode de vie avant de vous proposer la cuisine de vos rêves.",
      ...
      projets: [
        {
          titre: "",
          description: "",
          image: "../public/cuisines/emilie/emilie1.jpg",
          annee: "",
        },
        {
          titre: "",
          description: "",
          image: "../public/cuisines/emilie/emilie2.jpg",
          annee: "",
        },
        {
          titre: "",
          description: "",
          image: "../public/cuisines/emilie/emilie3.jpg",
          annee: "",
        },
        {
          titre: "",
          description: "",
          image: "../public/cuisines/emilie/emilie4.jpg",
          annee: "",
        },
        {
          titre: "",
          description: "",
          image: "../public/cuisines/emilie/emilie5.jpg",
          annee: "",
        },
      ],
      avis: [
...
Je recommande les yeux fermés !!!`,
    ...
    },
    {
      ...
      nom: "AMSTUTZ",
      titre: "Concepteur vendeur",
      photo: "../public/images/maxime.jpg",
      anciennete: 7,
      depuis: 2019,
      description:
        "Passionné par l'aménagement intérieur depuis plus de 7 ans, Julien accompagne chaque client avec une attention particulière aux détails et une écoute totale. Il transforme vos envies en espaces fonctionnels et esthétiques, en alliant modernité et chaleur humaine. Son approche ? Comprendre votre mode de vie avant de vous proposer la cuisine de vos rêves.",
      ...
      projets: [
        {
          titre: "",
          description: "",
          image: "../public/cuisines/maxime/maxime5.jpeg",
          annee: "",
        },
        {
          titre: "",
          description: "",
          image: "../public/cuisines/maxime/maxime2.jpeg",
          annee: "",
        },
        {
          titre: "",
          description: "",
          image: "../public/cuisines/maxime/maxime4.jpeg",
          annee: "",
        },
        {
          titre: "",
          description: "",
          image: "../public/cuisines/maxime/maxime3.jpeg",
          annee: "",
        },
        {
          titre: "",
          description: "",
          image: "../public/cuisines/maxime/maxime1.jpeg",
          annee: "",
        },
      ],
      avis: [
      ...
      projets: [
        {
          titre: "",
          description: "",
          image: "../public/cuisines/fred/fred3.jpg",
          annee: "",
        },
        {
          titre: "",
          description: "",
          image: "../public/cuisines/fred/fred2.jpg",
          annee: "",
        },
        {
          titre: "",
          description: "",
          image: "../public/cuisines/fred/fred1.jpg",
          annee: "",
        },
      ],
      avis: [
