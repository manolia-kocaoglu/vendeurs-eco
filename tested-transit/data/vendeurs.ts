  ...
  C’est un « bon vivant » qui apprécie de travailler dans une ambiance conviviale.`,
      ...
      avis: [
        ...
        },
        {
          auteur: "Samia Ch",
          note: 5,
          texte: "Bon rapport qualité prix, beaucoup de choix. Rapidité quand à la commande et livraison de la cuisine. Commercial aimable, et agréable il est de bon conseils, pour avoir fait plusieurs magasins de vente de cuisine je suis contente de ma nouvelle cuisine chez eco cuisine. Je recommande",
          date: "",
        },
      ],
      chiffres: [
